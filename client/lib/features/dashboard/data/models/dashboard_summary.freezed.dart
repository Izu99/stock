...
mixin _$DashboardSummary {
 ...
 double get totalStockValue; double get todaySales; double get monthlySales; double get totalExpenses; double get otherIncome; double get profit;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,totalStockValue,todaySales,monthlySales,totalExpenses,otherIncome,profit);

@override
String toString() {
  return 'DashboardSummary(totalStockValue: $totalStockValue, todaySales: $todaySales, monthlySales: $monthlySales, totalExpenses: $totalExpenses, otherIncome: $otherIncome, profit: $profit)';
}
...
@useResult
$Res call({
 double totalStockValue, double todaySales, double monthlySales, double totalExpenses, double otherIncome, double profit
});
...
/// Create a copy of DashboardSummary
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? totalStockValue = null,Object? todaySales = null,Object? monthlySales = null,Object? totalExpenses = null,Object? otherIncome = null,Object? profit = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double totalStockValue,  double todaySales,  double monthlySales,  double totalExpenses,  double otherIncome,  double profit)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DashboardSummary() when $default != null:
return $default(_that.totalStockValue,_that.todaySales,_that.monthlySales,_that.totalExpenses,_that.otherIncome,_that.profit);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double totalStockValue,  double todaySales,  double monthlySales,  double totalExpenses,  double otherIncome,  double profit)  $default,) {final _that = this;
switch (_that) {
case _DashboardSummary():
return $default(_that.totalStockValue,_that.todaySales,_that.monthlySales,_that.totalExpenses,_that.otherIncome,_that.profit);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double totalStockValue,  double todaySales,  double monthlySales,  double totalExpenses,  double otherIncome,  double profit)?  $default,) {final _that = this;
switch (_that) {
case _DashboardSummary() when $default != null:
return $default(_that.totalStockValue,_that.todaySales,_that.monthlySales,_that.totalExpenses,_that.otherIncome,_that.profit);case _:
  return null;
...
class _DashboardSummary implements DashboardSummary {
  const _DashboardSummary({required this.totalStockValue, required this.todaySales, required this.monthlySales, required this.totalExpenses, required this.otherIncome, required this.profit});
...
/// Create a copy of DashboardSummary
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? totalStockValue = null,Object? todaySales = null,Object? monthlySales = null,Object? totalExpenses = null,Object? otherIncome = null,Object? profit = null,}) {
