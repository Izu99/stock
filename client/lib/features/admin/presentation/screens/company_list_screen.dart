...
class _CompanyListScreenState extends ConsumerState<CompanyListScreen> {
  ...
  void initState() {
    super.initState();
    // Auto-refresh list when entering the screen
    Future.microtask(() {
                ...
                final filtered = companies
                    .where(
                      (c) =>
                          ...
                          c.owner.name.toLowerCase().contains(
                            _searchQuery.toLowerCase(),
                          ),
                    )
                    .toList();
            ...
            Row(
              ...
              children: [
                ...
                PopupMenuButton<String>(
                    ...
                    PopupMenuItem(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 8),
                          Text(
                            company.isActive ? l10n.deactivate : l10n.activate,
                          ),
                        ],
                      ),
                    ),
                  ...
                  onSelected: (value) {
                    if (value == 'edit') {
                      context.go('/admin/companies/edit', extra: company);
                    } else if (value == 'toggle') {
                      ref
                          .read(companiesProvider.notifier)
                          .toggleStatus(company.id, !company.isActive);
